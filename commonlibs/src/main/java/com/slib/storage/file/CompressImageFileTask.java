...
public class CompressImageFileTask extends AsyncTask<Void, Void, Void> {
    ...
    public CompressImageFileTask(ImageManager.ICompressImageFileListener listener, String shouldCompressedFilePath, int reqWidth, int reqHeight, int maxKb) {
    ...
    public CompressImageFileTask(ImageManager.ICompressImageFileListListener listListener, List<String> shouldCompressedFilePathList, int reqWidth, int reqHeight, int maxKb) {
